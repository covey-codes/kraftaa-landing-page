    ...
    <>
      ...
      <div className="bg-[rgb(29,26,58)] bg-opacity-100 overflow-x-clip">
        <div className="block md:hidden relative ml-[60px] top-[-150px] bg-[#B1FA63] border-2 border-[#1EAC23] rounded-3xl w-[85%] shadow-lg py-10 px-6">
          <motion.div initial="hidden" animate="visible" variants={slideInVariants} className="mt-5">
          ...
          <motion.div initial="hidden" animate="visible" variants={slideInVariants} className="mt-6">
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-4">
              {[
                ...
                <motion.div
                  key={index}
                  className={`px-4 py-2 rounded-full text-sm w-fit cursor-pointer border-2 border-black ${
          ...
          <div className="absolute top-[-20%] left-1/2 transform -translate-x-1/2 bg-[#B1FA63] border-2 border-[#1EAC23] w-[90%] h-[100%] rounded-3xl shadow-lg grid grid-cols-2 grid-rows-2 p-[30px]">
            <motion.div initial="hidden" animate="visible" variants={slideInVariants} className="flex -mt-24 ml-[90px] flex-col justify-center">
              <p className="text-6xl font-bold text-[#1D1A3A]">
                Any <span className="text-[#6828B0]">service</span> you need <br /> all in one{" "}
                <span className="text-[#6828B0]">place</span>
              </p>
            </motion.div>
